...
| --- | --- | --- | --- |
| Kepler | Lead (Architecture) | advisory | — |
| Cassini | Frontend Dev | advisory | — |
| Voyager | Backend Dev | advisory | — |
| Halley | Tester | advisory | — |

### Supported task types

Lead (Architecture), Frontend Dev, Backend Dev, Tester
