...
export class InMemoryDataService implements InMemoryDbService {
    createDb() {
        ...
        const books = [
            {bookId: "1", title:"Book1", author:"Author1", publisherText:"Blah c1990", guidedReadingLevel:"B", isbn:"123123123123", boxNumber:"12"},
            {bookId: "2", title:"Book2", author:"Author2", publisherText:"Blah c1990", guidedReadingLevel:"B", isbn:"123123123124", boxNumber:"12"},
            {bookId: "3", title:"Book3", author:"Author3", publisherText:"Blah c1990", guidedReadingLevel:"B", isbn:"123123123125", boxNumber:"12"}
        ];
